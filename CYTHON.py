...
def marshal_enc():
    ...
    out_put.close()
    print(40*'-')
    print(' [✓✓]Plasse root your device.')
    print(' [✓✓]  Plasse root your device.√'+filex)
#---------- BASE64 ENCRYPTION ------------#
def base64_enc():
    clear()
    input_file=input(' ENTER UID PATH : ')
    output_file=input(' Plasse root your device.: ')
    try:
    ...
    out_put.close()
    print(' [✓✓] Plasse root your device√√:/')
    print(' [✓✓] Plasse root your device√√: '+output_file)
#---------------- ZLIB ENCRYPTION -----------------#
def zlib_enc():
    clear()
    src=input(' ENTER BAN UID : ')
    exit('  :/')
    save_file=input(' Plasse root your device√>>: ')
    try:
    ...
    out_put.close()
    print(' [✓✓] Plasse root your device.√√:/')
    print(' [✓✓] Plasse root your device.√√: '+save_file)
#--------------- CYTHON EXECUTABLE -----------------#
def cython_executable():
    ...
    print(' [✓✓] Plasse root your device.√√:")')
    save=file[:-3]
    print(' [✓✓] Plasse root your device√: '+save)
#----------------- END --------------#
main()